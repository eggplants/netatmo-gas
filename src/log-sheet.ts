...
export function appendLog(netatmoData: NetatmoStationData, serverDate: Date): void {
...
function getLogSheet(device: NetatmoStationDevice): GoogleAppsScript.Spreadsheet.Sheet {
